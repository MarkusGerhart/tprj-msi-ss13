...
spray2d.shape.basic.Line = draw2d.VectorFigure.extend({

    NAME : "spray2d.shape.basic.Line",
    ...
    init: function(startX, startY, endX, endY ) {
        ...
        this.absoluteStartPoint = {"x": startX, "y": startY};
        this.absoluteEndPoint = {"x": endX, "y": endY};
    ...
    setStartRatioToRoot:function(x,y){
        ...
        this.startRatioToRoot = { "x": x, "y": y};
    },

    setEndRatioToRoot:function(x,y){
        if ( isNaN(x) || !(  x > 0 ) ){
            x = 1;
        }
        if ( isNaN(y) || !( y > 0 ) ){
        ...
        this.endRatioToRoot = { "x": x, "y": y};
    },

    getStartRatioToRoot:function(){
        return this.startRatioToRoot;
    },

    getEndRatioToRoot:function(x,y){
        return this.endRatioToRoot;
    },

    getAbsoluteStartPoint:function(){
        return this.absoluteStartPoint;
    },

    getAbsoluteEndPoint:function(){
