...
Der Bentuzer des Spray Web Editors kann aus den Shapes und Connections ein Modell
...
zu erstellen. Zudem kann das so entstandene Modell auch gespeichert werden.
...
umsetzten kann. Dabei hat sich das \dd-Framework auf Basis von JavaScript als
