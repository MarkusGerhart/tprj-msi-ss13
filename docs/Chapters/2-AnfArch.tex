...
\paragraph{spray.js} Dort befinden sich die der hauptsächliche Teil des Codes.
...
diese speziellen \dd~ Klassen werden in {\tt spray2d} gepflegt.
...
über einfache Klassenvererbung oder Delegation nicht losbar sind.
Das heißt bei einem Update von \dd~ müssen diese Änderungen unbedingt wieder
eingefügt werden.
