...
Dieser Prozess ist etwas aufwändiger weil bereits auf abeschlossene Commands zugegriffen werden muss. 
Manche Commands we Move werden automatisch erstellt, ausgeführt und auf den CommandStack gelegt)
Insbesondere der Move und Create Command müssen modifiert / ausgeführt werden.
...
Diese Generatoren sind noch nicht ins Spray-Projekt integiert, und müssen
...
\noindent Das {\tt compartments} Property enthält die die Referenz,
...
Dieses definiet, unter welcher Auswahlpalette die Klasse im grafischen Editor
...
zudem sollte von Editor gewährleistet werden, dass der Benutzer nur
