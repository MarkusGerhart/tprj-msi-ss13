 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.AnchorFixPointPositionImpl#getXcor <em>Xcor</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.AnchorFixPointPositionImpl#getYcor <em>Ycor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnchorFixPointPositionImpl extends AnchorPositionPosImpl implements AnchorFixPointPosition
{
  ...
  {
    return ShapePackage.Literals.ANCHOR_FIX_POINT_POSITION;
  }
  ...
  public void setXcor(int newXcor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ANCHOR_FIX_POINT_POSITION__XCOR, oldXcor, xcor));
  }
  ...
  public void setYcor(int newYcor)
  {
    ...
    ycor = newYcor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ANCHOR_FIX_POINT_POSITION__YCOR, oldYcor, ycor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.ANCHOR_FIX_POINT_POSITION__XCOR:
        return getXcor();
      case ShapePackage.ANCHOR_FIX_POINT_POSITION__YCOR:
        return getYcor();
    }
