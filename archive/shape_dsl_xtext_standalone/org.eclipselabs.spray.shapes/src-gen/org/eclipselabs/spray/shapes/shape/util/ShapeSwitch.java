...
public class ShapeSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ShapePackage.SHAPE_CONTAINER_ELEMENT:
      {
      ...
      case ShapePackage.ANCHOR_POSITION_POS:
      {
      ...
      case ShapePackage.SHAPE_CONNECTION:
      {
      ...
      case ShapePackage.COMPARTMENT_SHAPE:
      {
