 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.Compartment#getCompartmentLayout <em>Compartment Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.Compartment#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getCompartment()
 * @model
 * @generated
 */
public interface Compartment extends EObject
{
   ...
   * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getCompartment_CompartmentLayout()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.spray.shapes.shape.Compartment#getCompartmentLayout <em>Compartment Layout</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getCompartment_Shape()
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.spray.shapes.shape.Compartment#getShape <em>Shape</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
