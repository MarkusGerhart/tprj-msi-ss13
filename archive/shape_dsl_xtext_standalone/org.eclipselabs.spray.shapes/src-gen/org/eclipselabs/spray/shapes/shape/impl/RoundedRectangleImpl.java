 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.RoundedRectangleImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.RoundedRectangleImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoundedRectangleImpl extends ShapeImpl implements RoundedRectangle
{
  ...
  {
    return ShapePackage.Literals.ROUNDED_RECTANGLE;
  }
  ...
  public NotificationChain basicSetLayout(RoundedRectangleLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.ROUNDED_RECTANGLE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(RoundedRectangleLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ROUNDED_RECTANGLE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ROUNDED_RECTANGLE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ROUNDED_RECTANGLE__LAYOUT, newLayout, newLayout));
  }
  ...
  public EList<Shape> getShape()
  {
    if (shape == null)
    {
      shape = new EObjectContainmentEList<Shape>(Shape.class, this, ShapePackage.ROUNDED_RECTANGLE__SHAPE);
    }
    return shape;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.ROUNDED_RECTANGLE__LAYOUT:
        return basicSetLayout(null, msgs);
      case ShapePackage.ROUNDED_RECTANGLE__SHAPE:
