 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.Ellipse#getCompartmentInfo <em>Compartment Info</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.Ellipse#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.Ellipse#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getEllipse()
 * @model
 * @generated
 */
public interface Ellipse extends Shape
{
   ...
   * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getEllipse_CompartmentInfo()
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.spray.shapes.shape.Ellipse#getCompartmentInfo <em>Compartment Info</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getEllipse_Layout()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.spray.shapes.shape.Ellipse#getLayout <em>Layout</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.spray.shapes.shape.ShapePackage#getEllipse_Shape()
   * @model containment="true"
   * @generated
   */
