 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.AnchorManualImpl#getPosition <em>Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnchorManualImpl extends AnchorTypeImpl implements AnchorManual
{
  ...
  {
    return ShapePackage.Literals.ANCHOR_MANUAL;
  }
  ...
  public EList<AnchorPosition> getPosition()
  {
    if (position == null)
    {
      position = new EObjectContainmentEList<AnchorPosition>(AnchorPosition.class, this, ShapePackage.ANCHOR_MANUAL__POSITION);
    }
    return position;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.ANCHOR_MANUAL__POSITION:
