 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.ConnectionDefinitionImpl#getConnectionStyle <em>Connection Style</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.ConnectionDefinitionImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.ConnectionDefinitionImpl#getPlacing <em>Placing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectionDefinitionImpl extends ShapeContainerElementImpl implements ConnectionDefinition
{
  ...
  {
    return ShapePackage.Literals.CONNECTION_DEFINITION;
  }
  ...
  public void setConnectionStyle(ConnectionStyle newConnectionStyle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.CONNECTION_DEFINITION__CONNECTION_STYLE, oldConnectionStyle, connectionStyle));
  }
  ...
  public NotificationChain basicSetLayout(ShapestyleLayout newLayout, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.CONNECTION_DEFINITION__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(ShapestyleLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.CONNECTION_DEFINITION__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.CONNECTION_DEFINITION__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.CONNECTION_DEFINITION__LAYOUT, newLayout, newLayout));
  }
  ...
  public EList<PlacingDefinition> getPlacing()
  {
    if (placing == null)
    {
      placing = new EObjectContainmentEList<PlacingDefinition>(PlacingDefinition.class, this, ShapePackage.CONNECTION_DEFINITION__PLACING);
    }
    return placing;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.CONNECTION_DEFINITION__LAYOUT:
        return basicSetLayout(null, msgs);
      case ShapePackage.CONNECTION_DEFINITION__PLACING:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.CONNECTION_DEFINITION__CONNECTION_STYLE:
