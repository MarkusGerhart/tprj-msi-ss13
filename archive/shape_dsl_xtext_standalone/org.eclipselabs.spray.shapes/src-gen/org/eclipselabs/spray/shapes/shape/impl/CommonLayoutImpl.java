 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CommonLayoutImpl#getXcor <em>Xcor</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CommonLayoutImpl#getYcor <em>Ycor</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CommonLayoutImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CommonLayoutImpl#getHeigth <em>Heigth</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommonLayoutImpl extends MinimalEObjectImpl.Container implements CommonLayout
{
  ...
  {
    return ShapePackage.Literals.COMMON_LAYOUT;
  }
  ...
  public void setXcor(int newXcor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMMON_LAYOUT__XCOR, oldXcor, xcor));
  }
  ...
  public void setYcor(int newYcor)
  {
    ...
    ycor = newYcor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMMON_LAYOUT__YCOR, oldYcor, ycor));
  }
  ...
  public void setWidth(int newWidth)
  {
    ...
    width = newWidth;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMMON_LAYOUT__WIDTH, oldWidth, width));
  }
  ...
  public void setHeigth(int newHeigth)
  {
    ...
    heigth = newHeigth;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMMON_LAYOUT__HEIGTH, oldHeigth, heigth));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.COMMON_LAYOUT__XCOR:
        return getXcor();
      case ShapePackage.COMMON_LAYOUT__YCOR:
        return getYcor();
      case ShapePackage.COMMON_LAYOUT__WIDTH:
        return getWidth();
      case ShapePackage.COMMON_LAYOUT__HEIGTH:
        return getHeigth();
    }
