 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.PolylineImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolylineImpl extends ShapeImpl implements Polyline
{
  ...
  {
    return ShapePackage.Literals.POLYLINE;
  }
  ...
  public NotificationChain basicSetLayout(PolyLineLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.POLYLINE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(PolyLineLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.POLYLINE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.POLYLINE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.POLYLINE__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.POLYLINE__LAYOUT:
