 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CDRoundedRectangleImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CDRoundedRectangleImpl extends ShapeConnectionImpl implements CDRoundedRectangle
{
  ...
  {
    return ShapePackage.Literals.CD_ROUNDED_RECTANGLE;
  }
  ...
  public NotificationChain basicSetLayout(RoundedRectangleLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.CD_ROUNDED_RECTANGLE__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(RoundedRectangleLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.CD_ROUNDED_RECTANGLE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.CD_ROUNDED_RECTANGLE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.CD_ROUNDED_RECTANGLE__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.CD_ROUNDED_RECTANGLE__LAYOUT:
