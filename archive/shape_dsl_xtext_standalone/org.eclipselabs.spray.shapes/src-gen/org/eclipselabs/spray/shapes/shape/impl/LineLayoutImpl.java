 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.LineLayoutImpl#getPoint <em>Point</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.LineLayoutImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineLayoutImpl extends MinimalEObjectImpl.Container implements LineLayout
{
  ...
  {
    return ShapePackage.Literals.LINE_LAYOUT;
  }
  ...
  public EList<Point> getPoint()
  {
    if (point == null)
    {
      point = new EObjectContainmentEList<Point>(Point.class, this, ShapePackage.LINE_LAYOUT__POINT);
    }
    return point;
  }
  ...
  public NotificationChain basicSetLayout(ShapestyleLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.LINE_LAYOUT__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(ShapestyleLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.LINE_LAYOUT__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.LINE_LAYOUT__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.LINE_LAYOUT__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.LINE_LAYOUT__POINT:
        return ((InternalEList<?>)getPoint()).basicRemove(otherEnd, msgs);
      case ShapePackage.LINE_LAYOUT__LAYOUT:
