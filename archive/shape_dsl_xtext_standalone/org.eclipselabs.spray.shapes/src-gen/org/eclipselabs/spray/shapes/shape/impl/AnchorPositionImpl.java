 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.AnchorPositionImpl#getPos <em>Pos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnchorPositionImpl extends MinimalEObjectImpl.Container implements AnchorPosition
{
  ...
  {
    return ShapePackage.Literals.ANCHOR_POSITION;
  }
  ...
  public NotificationChain basicSetPos(AnchorPositionPos newPos, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.ANCHOR_POSITION__POS, oldPos, newPos);
  ...
  public void setPos(AnchorPositionPos newPos)
  {
    if (newPos != pos)
    {
      ...
      if (pos != null)
        msgs = ((InternalEObject)pos).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ANCHOR_POSITION__POS, null, msgs);
      if (newPos != null)
        msgs = ((InternalEObject)newPos).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ANCHOR_POSITION__POS, null, msgs);
      msgs = basicSetPos(newPos, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ANCHOR_POSITION__POS, newPos, newPos));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.ANCHOR_POSITION__POS:
