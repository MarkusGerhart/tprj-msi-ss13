 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentImpl#getCompartmentLayout <em>Compartment Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompartmentImpl extends MinimalEObjectImpl.Container implements Compartment
{
  ...
  {
    return ShapePackage.Literals.COMPARTMENT;
  }
  ...
  public void setCompartmentLayout(CompartmentLayout newCompartmentLayout)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT__COMPARTMENT_LAYOUT, oldCompartmentLayout, compartmentLayout));
  }
  ...
  public NotificationChain basicSetShape(CompartmentShape newShape, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT__SHAPE, oldShape, newShape);
  ...
  public void setShape(CompartmentShape newShape)
  {
    if (newShape != shape)
    {
      ...
      if (shape != null)
        msgs = ((InternalEObject)shape).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.COMPARTMENT__SHAPE, null, msgs);
      if (newShape != null)
        msgs = ((InternalEObject)newShape).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.COMPARTMENT__SHAPE, null, msgs);
      msgs = basicSetShape(newShape, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT__SHAPE, newShape, newShape));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.COMPARTMENT__SHAPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.COMPARTMENT__COMPARTMENT_LAYOUT:
