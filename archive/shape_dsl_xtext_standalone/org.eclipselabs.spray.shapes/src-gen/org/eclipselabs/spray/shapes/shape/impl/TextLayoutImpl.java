 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.TextLayoutImpl#getCommon <em>Common</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.TextLayoutImpl#getHAlign <em>HAlign</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.TextLayoutImpl#getVAlign <em>VAlign</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.TextLayoutImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextLayoutImpl extends MinimalEObjectImpl.Container implements TextLayout
{
  ...
  {
    return ShapePackage.Literals.TEXT_LAYOUT;
  }
  ...
  public NotificationChain basicSetCommon(CommonLayout newCommon, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__COMMON, oldCommon, newCommon);
  ...
  public void setCommon(CommonLayout newCommon)
  {
    if (newCommon != common)
    {
      ...
      if (common != null)
        msgs = ((InternalEObject)common).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.TEXT_LAYOUT__COMMON, null, msgs);
      if (newCommon != null)
        msgs = ((InternalEObject)newCommon).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.TEXT_LAYOUT__COMMON, null, msgs);
      msgs = basicSetCommon(newCommon, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__COMMON, newCommon, newCommon));
  }
  ...
  public void setHAlign(HAlign newHAlign)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__HALIGN, oldHAlign, hAlign));
  }
  ...
  public void setVAlign(VAlign newVAlign)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__VALIGN, oldVAlign, vAlign));
  }
  ...
  public NotificationChain basicSetLayout(ShapestyleLayout newLayout, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__LAYOUT, oldLayout, newLayout);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLayout(ShapestyleLayout newLayout)
  {
    if (newLayout != layout)
    {
      NotificationChain msgs = null;
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.TEXT_LAYOUT__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.TEXT_LAYOUT__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.TEXT_LAYOUT__LAYOUT, newLayout, newLayout));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.TEXT_LAYOUT__COMMON:
        return basicSetCommon(null, msgs);
      case ShapePackage.TEXT_LAYOUT__LAYOUT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.TEXT_LAYOUT__COMMON:
        return getCommon();
      case ShapePackage.TEXT_LAYOUT__HALIGN:
        return getHAlign();
      case ShapePackage.TEXT_LAYOUT__VALIGN:
        return getVAlign();
      case ShapePackage.TEXT_LAYOUT__LAYOUT:
        return getLayout();
    }
