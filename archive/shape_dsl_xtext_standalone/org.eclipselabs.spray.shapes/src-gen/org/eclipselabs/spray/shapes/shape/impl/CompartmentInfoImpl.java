 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getCompartmentLayout <em>Compartment Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getStretchH <em>Stretch H</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getStretchV <em>Stretch V</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getMargin <em>Margin</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#isInvisible <em>Invisible</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.CompartmentInfoImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompartmentInfoImpl extends MinimalEObjectImpl.Container implements CompartmentInfo
{
  ...
  {
    return ShapePackage.Literals.COMPARTMENT_INFO;
  }
  ...
  public void setCompartmentLayout(CompartmentLayout newCompartmentLayout)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__COMPARTMENT_LAYOUT, oldCompartmentLayout, compartmentLayout));
  }
  ...
  public void setStretchH(String newStretchH)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__STRETCH_H, oldStretchH, stretchH));
  }
  ...
  public void setStretchV(String newStretchV)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__STRETCH_V, oldStretchV, stretchV));
  }
  ...
  public void setSpacing(int newSpacing)
  {
    ...
    spacing = newSpacing;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__SPACING, oldSpacing, spacing));
  }
  ...
  public void setMargin(int newMargin)
  {
    ...
    margin = newMargin;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__MARGIN, oldMargin, margin));
  }
  ...
  public void setInvisible(boolean newInvisible)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__INVISIBLE, oldInvisible, invisible));
  }
  ...
  public NotificationChain basicSetId(TextBody newId, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__ID, oldId, newId);
  ...
  public void setId(TextBody newId)
  {
    if (newId != id)
    {
      ...
      if (id != null)
        msgs = ((InternalEObject)id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.COMPARTMENT_INFO__ID, null, msgs);
      if (newId != null)
        msgs = ((InternalEObject)newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.COMPARTMENT_INFO__ID, null, msgs);
      msgs = basicSetId(newId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.COMPARTMENT_INFO__ID, newId, newId));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.COMPARTMENT_INFO__ID:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ShapePackage.COMPARTMENT_INFO__COMPARTMENT_LAYOUT:
        return getCompartmentLayout();
      case ShapePackage.COMPARTMENT_INFO__STRETCH_H:
        return getStretchH();
      case ShapePackage.COMPARTMENT_INFO__STRETCH_V:
        return getStretchV();
      case ShapePackage.COMPARTMENT_INFO__SPACING:
        return getSpacing();
      case ShapePackage.COMPARTMENT_INFO__MARGIN:
        return getMargin();
      case ShapePackage.COMPARTMENT_INFO__INVISIBLE:
        return isInvisible();
      case ShapePackage.COMPARTMENT_INFO__ID:
        return getId();
    }
