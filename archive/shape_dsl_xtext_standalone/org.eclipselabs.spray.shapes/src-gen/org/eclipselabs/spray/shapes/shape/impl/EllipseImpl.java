 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.EllipseImpl#getCompartmentInfo <em>Compartment Info</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.EllipseImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.EllipseImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EllipseImpl extends ShapeImpl implements Ellipse
{
  ...
  {
    return ShapePackage.Literals.ELLIPSE;
  }
  ...
  public NotificationChain basicSetCompartmentInfo(CompartmentInfo newCompartmentInfo, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.ELLIPSE__COMPARTMENT_INFO, oldCompartmentInfo, newCompartmentInfo);
  ...
  public void setCompartmentInfo(CompartmentInfo newCompartmentInfo)
  {
    if (newCompartmentInfo != compartmentInfo)
    {
      ...
      if (compartmentInfo != null)
        msgs = ((InternalEObject)compartmentInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ELLIPSE__COMPARTMENT_INFO, null, msgs);
      if (newCompartmentInfo != null)
        msgs = ((InternalEObject)newCompartmentInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ELLIPSE__COMPARTMENT_INFO, null, msgs);
      msgs = basicSetCompartmentInfo(newCompartmentInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ELLIPSE__COMPARTMENT_INFO, newCompartmentInfo, newCompartmentInfo));
  }
  ...
  public NotificationChain basicSetLayout(RectangleEllipseLayout newLayout, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.ELLIPSE__LAYOUT, oldLayout, newLayout);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLayout(RectangleEllipseLayout newLayout)
  {
    if (newLayout != layout)
    {
      NotificationChain msgs = null;
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ELLIPSE__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.ELLIPSE__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.ELLIPSE__LAYOUT, newLayout, newLayout));
  }
  ...
  public EList<Shape> getShape()
  {
    if (shape == null)
    {
      shape = new EObjectContainmentEList<Shape>(Shape.class, this, ShapePackage.ELLIPSE__SHAPE);
    }
    return shape;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.ELLIPSE__COMPARTMENT_INFO:
        return basicSetCompartmentInfo(null, msgs);
      case ShapePackage.ELLIPSE__LAYOUT:
        return basicSetLayout(null, msgs);
      case ShapePackage.ELLIPSE__SHAPE:
