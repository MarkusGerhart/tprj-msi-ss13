 ...
 * <ul>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.PolygonImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipselabs.spray.shapes.shape.impl.PolygonImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolygonImpl extends ShapeImpl implements Polygon
{
  ...
  {
    return ShapePackage.Literals.POLYGON;
  }
  ...
  public NotificationChain basicSetLayout(PolyLineLayout newLayout, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShapePackage.POLYGON__LAYOUT, oldLayout, newLayout);
  ...
  public void setLayout(PolyLineLayout newLayout)
  {
    if (newLayout != layout)
    {
      ...
      if (layout != null)
        msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShapePackage.POLYGON__LAYOUT, null, msgs);
      if (newLayout != null)
        msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShapePackage.POLYGON__LAYOUT, null, msgs);
      msgs = basicSetLayout(newLayout, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ShapePackage.POLYGON__LAYOUT, newLayout, newLayout));
  }
  ...
  public EList<Shape> getShape()
  {
    if (shape == null)
    {
      shape = new EObjectContainmentEList<Shape>(Shape.class, this, ShapePackage.POLYGON__SHAPE);
    }
    return shape;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ShapePackage.POLYGON__LAYOUT:
        return basicSetLayout(null, msgs);
      case ShapePackage.POLYGON__SHAPE:
